...
variable "organization_domain" {
  description = "the domain (.com) of the organization"
  type        = string
}

variable "billing_account" {
  description = "The id of the billing account (GUID)"
  type        = string
}

variable "group_network_admins" {
  description = "Google Group for GCP Network Admins"
  type        = string
}
...
variable "network_name" {
  description = "Name for the network that will be used with the network endpoint group."
  type        = string
}
...
variable "subnetwork" {
  description = "Name for the subnetwork that will be used with the network endpoint group."
  type        = string
}
...
variable "impersonate_service_account" {
  description = "Terraform impersonation service account"
  type        = string
}
